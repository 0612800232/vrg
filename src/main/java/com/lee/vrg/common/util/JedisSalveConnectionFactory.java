 ...
 */
public class JedisSalveConnectionFactory implements InitializingBean, DisposableBean, RedisConnectionFactory {

	private final static Log log = LogFactory.getLog(JedisSalveConnectionFactory.class);
	 ...
	 * shard information).
	 */
	public JedisSalveConnectionFactory() {}
	 ...
	 */
	public JedisSalveConnectionFactory(JedisShardInfo shardInfo) {
	 ...
	 */
	public JedisSalveConnectionFactory(JedisPoolConfig poolConfig) {
		this(null, poolConfig);
	}

	/**
	 * Constructs a new {@link JedisSalveConnectionFactory} instance using the given {@link JedisPoolConfig} applied to
	 * {@link JedisSentinelPool}.
	 * 
	 * @param sentinelConfig
	 * @since 1.4
	 */
	public JedisSalveConnectionFactory(RedisSentinelConfiguration sentinelConfig) {
	 ...
	 * @since 1.4
	 */
	public JedisSalveConnectionFactory(RedisSentinelConfiguration sentinelConfig, JedisPoolConfig poolConfig) {
	...
	protected Pool<Jedis> createRedisSentinelPool(RedisSentinelConfiguration config) {
		return new JedisSalveSentinelPool(config.getMaster().getName(), convertToJedisSentinelSet(config.getSentinels()),
